  ...
  <section id="about" className="py-24 bg-section-alt">
    <div className="container mx-auto px-4">
      ...
      <div className="max-w-3xl">
        ...
        <p className="text-lg text-muted-foreground leading-relaxed mb-6">
          I specialize in React, Next.js, JavaScript, responsive design, clean UI,
          and API integration. I enjoy learning new technologies, exploring best practices,
          and improving my problem-solving skills every day.
        </p>
        <p className="text-lg text-muted-foreground leading-relaxed">
          Whether you need a personal portfolio, a business website, or a custom web app,
          I deliver professional, high-quality results that help you stand out online.
        </p>
      </div>
    </div>
  </section>
